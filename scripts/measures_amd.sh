...
commands=("measure_gcc_NOOPT" "measure_O3_gcc_NOOPT" "measure_OFast_gcc_NOOPT" "measure_O3NATIVE_gcc_NOOPT" "measure_AVX2_gcc_NOOPT" "measure_OCUSTOM_gcc_NOOPT" "measure_AOCC_NOOPT")
